...
export default function Summons() {
  ...
  const summons = (currentCase as any).summons || [];
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground">
            Genereer en beheer dagvaardingen voor uw zaak
          </p>
        </div>
      </div>
        ...
        <CardContent className="py-12">
          <div className="text-center">
            ...
            <h3 className="text-xl font-semibold text-foreground mb-2">
              Dagvaarding functionaliteit
            </h3>
            <p className="text-muted-foreground mb-6">
              De mogelijkheid om dagvaardingen op te stellen wordt binnenkort toegevoegd.
              {hasSummons && " Bestaande dagvaardingen worden hier weergegeven."}
            </p>
            {hasSummons ? (
              <GeneratedDocuments
                letters={[]}
