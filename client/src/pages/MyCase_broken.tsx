      ...
      <div className="space-y-6">
        ...
        {expandedSection === 'analyse' && (
          <div className="space-y-6">
            ...
            {/* SIMPLE SUCCESS STATE - Just show MindStudio data directly */}
            {analysisData && !analysisLoading && (
              <div className="container mx-auto space-y-6">
                ...
                {/* Old complex sections - keeping for reference */}
                <details className="bg-gray-50 border rounded p-4">
                  <summary className="cursor-pointer font-semibold">🔍 Oude complexe UI (klik om uit te klappen)</summary>
