...
export default function Jurisprudentie() {
  ...
  const generateQueryMutation = useMutation({
    ...
    onSuccess: (data: any) => {
      ...
      // Reset threshold to 10% for AI-generated queries
      setScoreThreshold(0.10);
      ...
      if (data.requiredKeywords && Array.isArray(data.requiredKeywords) && data.requiredKeywords.length > 0) {
        ...
        toast({
          ...
          description: `Zoekvraag, ${data.requiredKeywords.length} verplichte ${data.requiredKeywords.length === 1 ? 'woord' : 'woorden'}, en relevantiedrempel (10%) ingesteld`,
        });
      } else {
        toast({
          title: "AI zoekvraag gegenereerd",
          description: "Zoekvraag en relevantiedrempel (10%) ingesteld op basis van uw juridisch advies",
        });
      }
    },
    onError: (error: any) => {
