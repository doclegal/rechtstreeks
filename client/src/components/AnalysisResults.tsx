...
export default function AnalysisResults({ 
  ...
  // Track if sections are open - Kantonzaak starts open on first analysis
  const [isKantonOpen, setIsKantonOpen] = useState(true);
  const [isJuridischOpen, setIsJuridischOpen] = useState(false);
  ...
  // Parse MindStudio analysis for the Juridische Analyse section
  ...
  return (
    <div className="space-y-6">
      {/* Kantonzaak Controle Section - Collapsible */}
      <Collapsible open={isKantonOpen} onOpenChange={setIsKantonOpen}>
        <Card className={`${
          ...
          <CardHeader>
            <div className="flex items-center justify-between">
              ...
              <CollapsibleTrigger asChild>
                <Button variant="ghost" size="sm" data-testid="button-toggle-kanton">
                  {isKantonOpen ? (
      ...
      {/* Juridische Analyse Section - Collapsible, shown when fullAnalysis exists */}
      {mindstudioAnalysis && caseId && (
        <Collapsible open={isJuridischOpen} onOpenChange={setIsJuridischOpen}>
          <Card className="border-blue-200 bg-blue-50 dark:border-blue-800 dark:bg-blue-950/30">
            <CardHeader>
              <div className="flex items-center justify-between">
                ...
                <CollapsibleTrigger asChild>
                  <Button variant="ghost" size="sm" data-testid="button-toggle-juridisch">
                    {isJuridischOpen ? (
                      <ChevronUp className="h-4 w-4" />
                    ) : (
                      <ChevronDown className="h-4 w-4" />
